...
export const metadata: Metadata = {
  ...
  description:
    "מסלול מוכח מלימודים לאזרחות. תואר שני באוניברסיטה מובילה בניו זילנד או אוסטרליה. ליווי מלא עד קבלת Offer of Place — כרטיס הכניסה שלך.",
  keywords: [
    "הגירה לניו זילנד",
    "לימודים בניו זילנד",
    "הגירה לאוסטרליה",
  ...
  openGraph: {
    ...
    description:
      "מסלול מוכח מלימודים לאזרחות בניו זילנד ואוסטרליה. ליווי מלא עד קבלת Offer of Place.",
...
const serviceJsonLd = {
  ...
  description:
    "ליווי מקצועי לישראלים בתהליך הגירה לניו זילנד ואוסטרליה דרך מסלול לימודים אקדמיים. מהייעוץ הראשוני ועד קבלת Offer of Place — כרטיס הכניסה שלך ללימודים.",
  provider: {
    "@type": "Organization",
    name: "Relocation IL",
    url: "https://relocationil.com",
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  desc: "אנחנו מכינים את כל המסמכים, מגישים מועמדות, ומלווים אותך עד לקבלת Offer of Place — כרטיס הכניסה שלך ללימודים.",
                },
                {
                  step: 4,
                  icon: Home,
                ...
                },
                {
                  ...
                  desc: "הליווי שלנו מסתיים ב-Offer of Place — מכתב הקבלה הרשמי שפותח את הדלת לויזה, ללימודים, ולחיים החדשים.",
                },
              ].map((item, i) => (
                <AnimatedSection key={i} delay={i * 100}>
