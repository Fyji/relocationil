...
const steps = [
  ...
  },
  {
    ...
    includes: [
      ...
      "הגשת בקשת ויזת סטודנט",
      "טיפול בביטוח בריאות",
      "ליווי מול שגרירות/קונסוליה",
    ],
  },
  {
    number: 4,
  ...
  },
  {
    ...
    description:
      "גם אחרי שהגעתם, אנחנו כאן. ליווי אקדמי, תעסוקתי, וסיוע בהליכי הגירה — עד שתרגישו בבית.",
    includes: [
      "ליווי אקדמי שוטף",
      "סיוע בחיפוש עבודה",
      "הכוונה להליך PR (תושבות קבע)",
      "תמיכה בהתאקלמות",
      "מענה לכל שאלה שתעלה",
    ],
  },
...
const processFaq = [
  {
    ...
    a: "בממוצע, מרגע שיחת הייעוץ הראשונה ועד הנחיתה ביעד — כ-4 עד 8 חודשים. התזמון תלוי במועדי הקבלה של המוסד ובזמני עיבוד הויזה.",
  },
  {
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center text-white">
          <AnimatedSection>
            ...
            <p className="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto">
              מהשיחה הראשונה ועד שתרגישו בבית — אנחנו איתכם בכל שלב
            </p>
          </AnimatedSection>
        </div>
      </section>
