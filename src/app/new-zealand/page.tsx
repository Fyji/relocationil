...
export const metadata: Metadata = {
  ...
  description:
    "מדריך מלא להגירה לניו זילנד: אוניברסיטאות מובילות, תוכניות תואר שני, Green List, ויזת עבודה ל-3 שנים, ותושבות קבועה. ליווי מקצועי עד קבלת Offer of Place.",
  keywords: [
    "הגירה לניו זילנד",
    "לימודים בניו זילנד",
    "תואר שני בניו זילנד",
...
const nzServiceJsonLd = {
  ...
  description:
    "ליווי מקצועי לישראלים בתהליך הגירה לניו זילנד: מהייעוץ הראשוני ועד קבלת Offer of Place — כרטיס הכניסה שלך.",
  provider: {
    "@type": "Organization",
    name: "Relocation IL",
