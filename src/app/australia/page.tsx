...
export const metadata: Metadata = {
  ...
  description:
    "מדריך מלא להגירה לאוסטרליה: אוניברסיטאות Group of Eight, תוכניות תואר שני, ויזת עבודה ל-4 שנים, מערכת ניקוד, ותושבות קבועה. ליווי מקצועי עד קבלת Offer of Place.",
  keywords: [
    "הגירה לאוסטרליה",
    "לימודים באוסטרליה",
    "תואר שני באוסטרליה",
...
const auServiceJsonLd = {
  ...
  description:
    "ליווי מקצועי לישראלים בתהליך הגירה לאוסטרליה: מהייעוץ הראשוני ועד קבלת Offer of Place — כרטיס הכניסה שלך.",
  provider: {
    "@type": "Organization",
    name: "Relocation IL",
