...
const faqCategories = [
    ...
    questions: [
      {
        ...
        a: "אנחנו מלווים ישראלים בתהליך מלא של מעבר לחיים חדשים בניו זילנד או אוסטרליה דרך מסלול לימודים. מהייעוץ הראשוני, דרך בחירת מוסד ותוכנית, ועד קבלת Offer of Place — כרטיס הכניסה שלך ללימודים.",
      },
      {
        q: "למי השירות מתאים?",
      ...
      },
      {
        ...
        a: "אנחנו חוסכים לכם זמן, טעויות וכסף. יש לנו ניסיון עם מאות מקרים, קשרים ישירים עם מוסדות, וידע מעמיק בהליכי ויזה. טעות בהגשה יכולה לעכב את קבלת ה-Offer of Place.",
      },
      {
        q: "כמה זמן לוקח כל התהליך?",
        a: "בממוצע 4-12 שבועות מרגע שיחת הייעוץ ועד קבלת Offer of Place. התזמון תלוי במועדי הקבלה של המוסד ובמורכבות התיק.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "האם קל להתרגל?",
        a: "ניו זילנד ואוסטרליה הן מדינות מסבירות פנים עם תרבות פתוחה ומכבדת. רוב הישראלים מתאקלמים תוך חודשים ספורים. הליווי שלנו מתחיל מה-Offer of Place וכולל גם תמיכה בהתאקלמות.",
      },
    ],
  },
];
